...
computeDegree(cw_in,'indegree.txt')
computeDegree(cw_out,'outdegree.txt')
...
clu = computeCluster(cw)
print "average clustering coeffecient:", clu[0], "\n"
print "overall clustering coeffecient:", clu[1], "\n"
